...
class LongformerTS(nn.TransformerEncoderLayer):
    def __init__(self,
                 d_model: int,
                 nhead: int,
                 dim_feedforward: int = 2048,
                 attention_window: int = None,
                 attention_dilation: int = None,
...
class LongformerSelfAttention(nn.MultiheadAttention):
    ...
    def forward(self, query: Tensor, key: Tensor, value: Tensor, key_padding_mask: Optional[Tensor] = None,
        ...
        # because the input to the LongformerSelfAttention is always of shape [bsz, seq_len, dim], we make sure src is of shape [bsz, seq_len, dim]
